angular.module('storycontroller', [])
  ...
  .controller('storyCtrl',function($scope, $ionicModal, $timeout, $lifestory,$ionicPlatform,$ionicHistory, $nodes, $addEvent, $deleteTreeFactory, $ionicPopup,$localstorage, $state, $filter, $cordovaCamera, $cordovaFile, $cordovaFileTransfer, $cordovaDevice, $cordovaActionSheet, $stateParams,$galleryFactory,$translate,$cordovaSocialSharing,$ionicLoading,$ionicPopover,$commonFactory,$getContactFactory)     
  {
    ...
    $scope.addFamilyMember = function(){
        $state.go('app.form',{'nodeID':$stateParams.nodeID,'activeTab':'b'});
    }
    ...
    $scope.shareRelation = function(name,relation){
      ...
      var link = "<a href='http://qabilati.com/'>qabilati.com</a>";
     // var msg = name + " is " + relation + " of " + mainUsername ;
    ...
    $scope.invitePeople = function(){
        $state.go('app.treeSettings',{'nodeID':$stateParams.nodeID,'activeTab':'a'});
    }
    ...
    $scope.showSuccessAlert = function(msg) {
      var alertPopup = $ionicPopup.alert({
        ...
        buttons: [{
          ...
          type: 'button-positive',
          onTap: function(e) {
            $state.go('app.FamilyMemberLifeStory',{'nodeID':userNodeId,'activeTab':'b'});
          }
        }, ]
      });
    };
